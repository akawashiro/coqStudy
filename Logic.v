...
(* Definition plus_zero : forall n: nat,  n + 0 = 0 -> n = 0. *)
(* Proof. intros n eq1. induction n as [| n']. *)
(*        simpl in eq1. apply eq1. *)
(*        simpl in eq1. inversion. *)
(** **** Exercise: 2 stars (and_exercise)  *)
Example and_exercise :
  forall n m : nat, n + m = 0 -> n = 0 /\ m = 0.
Proof. intros n m eq1. apply and_intro. destruct m.  simpl in eq1.
...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q H. unfold not. intros G. intros I. apply H in I. apply G in I. apply I. Qed.
(** [] *)
...
Proof.
  ...
  - intros H.
    destruct H. destruct H as [m Hm]. exists m. left. apply Hm.
    destruct H as [m Hm]. exists m. right. apply Hm.
Qed.
(** [] *)
